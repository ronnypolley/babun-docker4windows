...
# winpty version
babun_docker_winpty_version="0.4.0"

# winpty base URL
babun_docker_winpty_base_url="https://github.com/rprichard/winpty/releases/download/${babun_docker_winpty_version}/"

# Specific file name, separated to allow unzipping it later
babun_docker_winpty_only_name="winpty-${babun_docker_winpty_version}-cygwin-2.5.2-ia32"
...
babun_docker_repo_dir="$HOME/.babun-docker4windows"
